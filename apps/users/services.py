...
def obtener_estado_operativo(usuario):
    ...
    if perfil is None:
        return {
            "puede_apostar": False,
            "estado_kyc": "sin_perfil",
            "motivo": "No tienes perfil KYC registrado.",
            "tiene_perfil": False,
            "tiene_autoexclusion_activa": False,
        }

    tiene_autoexclusion_activa = usuario.exclusiones.filter(activa=True).filter(
    ...
    return {
        ...
        "motivo": motivo,
        "tiene_perfil": True,
        "tiene_autoexclusion_activa": tiene_autoexclusion_activa,
    }
