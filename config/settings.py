...
# Definimos que la aplicación principal de ejecución será ASGI y no WSGI
...
INSTALLED_APPS = [
    'daphne',  # 👈 ¡DEBE IR PRIMERO QUE TODO!
...
# Footer legal (front debe mostrarlo)
FAIRBET_AVISO_LEGAL = (
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {
            # Quitamos los wrappers complejos y apuntamos al pool directo por IP interna
            "hosts": [("fairbet_redis", 6379)],
        },
    },
}